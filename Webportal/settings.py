...
SECRET_KEY = 'django-insecure-8@%j1)uph2_^s2rg_=yn16z!_cabb3f!j^e3o^q+y3ta_@61i='
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'fadpayslip1995@gmail.com'
EMAIL_HOST_PASSWORD = 'qvzjdgtmxczcixsj'
DEFAULT_FROM_EMAIL = 'fadpayslip1995@gmail.com'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # 'Messages.context_processors.conversation_context_processor',
            ],
        },
    },
]
...
LOGGING = {
    ...
    'loggers': {
        ...
        # Add a logger for your application
        'Certificate': {
            'handlers': ['console'],
            'level': 'INFO',
        },
